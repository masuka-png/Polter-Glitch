...
public class ElevatorDoor : MonoBehaviour
{
    ...
    [SerializeField] private Vector3 _openDirection = Vector3.right; // Direction the door slides
    [SerializeField] private float _openDistance = 1.5f; // How far the door opens
